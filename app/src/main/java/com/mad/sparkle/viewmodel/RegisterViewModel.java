...
public class RegisterViewModel extends ViewModel {
    ...
    public static void setImageURI(de.hdodenhof.circleimageview.CircleImageView activityRegisterProfileImage, Uri registerViewModelImageUriGet) {
    }
    ...
    public static void voidsetErrorMessage(EditText editText, String errorMessage) {
